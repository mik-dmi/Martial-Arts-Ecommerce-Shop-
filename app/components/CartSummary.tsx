...
const CartSummary = () => {
  ...
  function onCheckout() {}
    const shippingRate = cartCount! > 0 ? 800 : 0
    const totalAmount = totalPrice! + shippingRate
  return (
    <section
    ...
    >
      ...
      <dl className="mt-6 space-y-4">
        ...
        <div className="flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-600">
          ...
          <dd className="text-sm font-medium">{formatCurrencyString({value: shippingRate , currency: "EUR" })}</dd>
        </div>
        <div className="flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-600">
